...
then
	...
	sudo -H -u $SUDO_USER git clone --depth 1 --branch v1.8.7 https://github.com/indilib/indi.git 
...
then
	cd $USERHOME/AstroRoot/
	sudo -H -u $SUDO_USER git clone --depth 1 --branch 3.5.0 https://github.com/KDE/kstars
